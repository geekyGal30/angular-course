...
beforeAll:: This function is called *once*, _before_ all the specs in `describe` test suite are run.

afterAll:: This function is called *once* _after_ all the specs in a test suite are finished.

beforeEach:: This function is called _before_ *each* test specification, `it` function, has been run.

afterEach:: This function is called _after_ *each* test specification has been run.
